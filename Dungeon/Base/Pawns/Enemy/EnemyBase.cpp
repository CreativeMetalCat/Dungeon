...
void Engine::CEnemyBase::Update()
{
	...
	Array<CBaseObject*>::iterator it = std::find_if(World->Objects.begin(), World->Objects.end(), [this](CBaseObject* obj) {return obj->Location.Distance(Location) <= Range && obj != this && obj->Faction != Faction::Player; });
